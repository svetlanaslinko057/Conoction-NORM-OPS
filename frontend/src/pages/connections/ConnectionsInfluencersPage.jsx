  ...
  return (
    <div className="min-h-screen bg-gray-50" data-testid="influencers-page">
      <div className="max-w-7xl mx-auto px-4 py-4 md:py-6">
        ...
        {/* Navigation Tabs */}
        <div className="flex items-center gap-2 mb-4 overflow-x-auto pb-2 -mx-4 px-4 md:mx-0 md:px-0 scrollbar-hide">
          <span className="px-3 md:px-4 py-2 rounded-lg text-xs md:text-sm font-medium bg-purple-100 text-purple-700 flex items-center gap-2 whitespace-nowrap flex-shrink-0">
            <Users className="w-4 h-4" />
            Influencers
          </span>
          <Link
            to="/connections/graph"
            className="px-3 md:px-4 py-2 rounded-lg text-xs md:text-sm font-medium text-gray-600 hover:bg-gray-100 transition-colors flex items-center gap-2 whitespace-nowrap flex-shrink-0"
          >
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-3 md:p-4 mb-4 md:mb-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-4 mb-3 md:mb-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              >
                <SelectTrigger className="w-32 md:w-44 h-10 md:h-9 bg-white text-xs md:text-sm" data-testid="influencer-sort">
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-1 -mx-3 px-3 md:mx-0 md:px-0 md:flex-wrap scrollbar-hide">
